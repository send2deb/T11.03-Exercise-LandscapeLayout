...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        mBinding.flightInfoLayout.textViewOriginAirport.setText(info.originCode);
        mBinding.flightInfoLayout.textViewFlightCode.setText(info.flightCode);
        mBinding.flightInfoLayout.textViewDestinationAirport.setText(info.destCode);
        ...
        mBinding.boardingInfoLayout.textViewTerminal.setText(info.departureTerminal);
        mBinding.boardingInfoLayout.textViewGate.setText(info.departureGate);
        mBinding.boardingInfoLayout.textViewSeat.setText(info.seatNumber);
    }
}
